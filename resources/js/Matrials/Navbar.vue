...
import Dropdown from "@/Matrials/Dropdown.vue";
import SearchModal from "@/Matrials/SearchModal.vue";
...
<template>
  <div class="w-full text-gray-700 bg-white dark:text-gray-200 dark:bg-gray-800">
    <div class="
      ...
      <nav :class="{ flex: openMobileMenu, hidden: !openMobileMenu }" class="
            flex-col flex-grow
            pb-4
